...
import { Card, ListItem, SectionTitle, StatCard } from '../../src/components/controls';
    ...
    <GradientScreen>
      ...
      <KeyboardScreen>
        ...
        <ListItem
          ...
          subtitle="باقات شهرية/سنوية/مخصصة وتجديد أو إيقاف الاشتراك"
          icon="card"
...
const styles = StyleSheet.create({
  ...
  heroTitle: { color: '#fff', fontSize: font.lg, fontWeight: '900', textAlign: 'right' },
  heroSub: { color: 'rgba(255,255,255,0.85)', fontSize: font.xs, marginTop: 2, textAlign: 'right' },
});
