// ============================================================
// نظام المدرس التابع: الصلاحيات التفصيلية ونطاق المجموعات
// المسئول يفعّل/يوقف ويمنح/يسحب كل صلاحية من شاشة المدرسين.
// ============================================================
...
/** هل يملك البروفايل صلاحية معينة؟ (المالك = كامل دوماً) */
